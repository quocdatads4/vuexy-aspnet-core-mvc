      ...
      gulpIf(
        ...
        exec(
          ...
          gulpIf(
            ...
            gulpIf(
              conf.fastDev,
              `sass --load-path=node_modules/  src/site.scss:${conf.distPath}/css/site.css src/scss:${conf.distPath}/vendor/css src/scss/rtl:${conf.distPath}/vendor/css/rtl src/scss/pages:${conf.distPath}/vendor/css/pages src/fonts:${conf.distPath}/vendor/fonts src/libs:${conf.distPath}/vendor/libs --no-source-map`
            )
          ),
          function (err) {
            cb(err);
